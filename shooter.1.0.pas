...
begin
  ...
  writeln('                              Выход                        esc');
  writeln();
  write('                              ');textcolor(LIGHTGREEN);write('☼');textcolor(WHITE);writeln(' - бонус +10 патронов и +1 бомба');
...
begin
  ...
  begin
    ...
    textcolor(RED);
writeln('                                                                                                                        ');
writeln('                RRRRRR                      EEEEEEEEEEEEEE            DDDDD                                             ');
writeln('               R      R                    E            E            D      D                                           ');
writeln('              R        R                  E                         D        D                                          ');
writeln('             R         R                 E                         D          D                                         ');
writeln('            R          R                E                         D           D                                         ');
...
writeln('         R        R                  E                         D             D                                          ');
writeln('        R       R                   E        E                D             D                                           ');
writeln('       RRRRRRRR                    EEEEEEEEEE                D             D                                            ');
writeln('      R       R                   E        E                D             D                                             ');
writeln('     R         R                 E             E           D            D                                               ');
writeln('    R            R              EEEEEEEEEEEEEEE           DDDDDDDDDDDDD                                                 ');
writeln('                                                                                                                        ');
  end
  else
  begin
    textcolor(BLUE);
writeln('                                                                                                                        ');
writeln('               BBBBBBBBB          L                U              U       EEEEEEEEEEEEEE                                ');
writeln('              B         B        L                U              U       E            E                                 ');
writeln('             B           B      L                U              U       E                                               ');
writeln('            B            B     L                U              U       E                                                ');
writeln('           B            B     L                U              U       E                                                 ');
writeln('          B            B     L                U              U       E                                                  ');
...
writeln('        B          B       L                U              U       E                                                    ');
writeln('       B         B        L                U              U       E        E                                            ');
writeln('      BBBBBBBBBB         L                U              U       E EEEEEEEE                                             ');
writeln('     B           B      L                 U             U       E        E                                              ');
writeln('    B          B       L                  U             U      E              E                                         ');
writeln('   BBBBBBBBBB         LLLLLLLLLLLLLLL      UUUUUUUUUUUU  UU   EEEEEEEEEEEEEEEE                                          ');
writeln('                                                                                                                        ');
  end;
writeln('                                                                                                       !!!!!            ');
writeln('                                                                               i                       !!!!!            ');
...
writeln('                                         w                          w          i                        !!!             ');
writeln('                                          w                        w                                    !!!             ');
writeln('                                           w                      w         iiii       n  nnnn          !!!             ');
writeln('                                            w            w       w             i       nn     n         !!!             ');
writeln('                                             w          w       w              i       n       n         !              ');
writeln('                                              w        w       w               i       n       n         !              ');
writeln('                                               w      w w     w                i       n       n         !              ');
writeln('                                                w    w   w   w                 i       n       n                        ');
writeln('                                                 w  w     w w                  i       n       n         !              ');
writeln('                                                  w        w                   i       n       n        ! !        Нажми');
writeln('                                                                                                         !         Enter');
textcolor(WHITE);
readln();
end;
